...
public class TelaCadastroProdutos extends JFrame {
	...
	public TelaCadastroProdutos() throws ParseException {
		...
		panel.setBounds(10, 151, 554, 154);
		contentPane.add(panel);
		panel.setLayout(null);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(535, -13, -533, 170);
		...
		tableProdutos.setModel(new DefaultTableModel(
			...
			new String[] {
				"ID", "Descri\u00E7\u00E3o", "Categoria", "Valor", "Qtde", "Fornecedor"
			}
		));
		...
		tableProdutos.getColumnModel().getColumn(3).setPreferredWidth(26);
		...
		tableProdutos.setBounds(12, 11, 534, 132);
		panel.add(tableProdutos);
