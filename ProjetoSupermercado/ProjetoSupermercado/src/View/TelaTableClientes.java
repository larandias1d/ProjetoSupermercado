...
public class TelaTableClientes extends JFrame {
	...
	public TelaTableClientes() throws ParseException {
		setIconImage(Toolkit.getDefaultToolkit().getImage(TelaTableClientes.class.getResource("/Imagem/cliente.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(TelaTableClientes.class.getResource("/Imagem/fundo2.png")));
		lblNewLabel_1.setBounds(0, 0, 1370, 705);
